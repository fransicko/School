...
void drawMyPyramid() {
	glm::mat4 transMtx = glm::translate(glm::mat4(), glm::vec3(-25, -25, 0));
	glMultMatrixf(&transMtx[0][0]); {
		drawMyTriangle();
	}; glMultMatrixf( &(glm::inverse( transMtx ))[0][0] );
	
	transMtx = glm::translate(glm::mat4(), glm::vec3(75, -25, 0));
	glMultMatrixf(&transMtx[0][0]); {
		drawMyTriangle();
	}; glMultMatrixf( &(glm::inverse( transMtx ))[0][0] );
	
	transMtx = glm::translate(glm::mat4(), glm::vec3(25, 55, 0));
	glMultMatrixf(&transMtx[0][0]); {
		drawMyTriangle();
	}; glMultMatrixf( &(glm::inverse( transMtx ))[0][0] );
}
